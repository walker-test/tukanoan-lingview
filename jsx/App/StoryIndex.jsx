      ...
      <div id="index">
        <table id="indexTable">
          <thead>
            <tr>
              <th>
                <TranslatableText dictionary={indexPageTitleHeaderText} />
              </th>
              <th>
                <TranslatableText dictionary={indexPageAuthorHeaderText} />
              </th>
              <th>
                <TranslatableText dictionary={indexPageMediaHeaderText} />
              </th>
            </tr>
          </thead>
        </table>
