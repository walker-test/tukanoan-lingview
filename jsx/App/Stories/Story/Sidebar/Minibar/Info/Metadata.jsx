...
export function Metadata({ metadata }) {
  ...
  if (metadata["description"] != "") {
    description = (
      <p>
        <b>
          <TranslatableText dictionary={metadataDescriptionText} />:
        </b>{" "}
  ...
  if (metadata["author"] != "") {
    author = (
      <p>
        <TranslatableText dictionary={metadataAuthorText} />:{" "}
        {metadata["author"]}
      </p>
    );
  }
  ...
  if (metadata["genre"] != "") {
    genre = (
      <p>
        <TranslatableText dictionary={metadataGenreText} />: {metadata["genre"]}
      </p>
    );
  }
  ...
  if (metadata["date_created"] != "") {
    date_created = (
      <p>
        <TranslatableText dictionary={metadataDateText} />:{" "}
...
export function MoreMetadata({ metadata }) {
  ...
  if (metadata["glosser"] != "") {
    glosser = (
      <p>
        <TranslatableText dictionary={metadataGlosserText} />:{" "}
        {metadata["glosser"]}
      </p>
    );
  }
  ...
  if (metadata["source"]["_default"] != "") {
    source = (
      <p>
        <TranslatableText dictionary={metadataSourceText} />:{" "}
        {metadata["source"]["_default"]}
      </p>
    );
  } else if (
    metadata["source"].hasOwnProperty("con-Latn-EC") &&
