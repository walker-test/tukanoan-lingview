...
try {
	...
	console.log("\nYou've successfully deleted this file. However, this will not be displayed on the index until you run the batch.js script. You can run this script from the root directory with the command 'node preprocessing/batch.js'. We recommend doing this immediately.");
} catch(err) {
