    ...
    .prompt([
      ...
      // mp3
      {
        ...
        when: function (answers) {
          const condition =
            hasTimestamps(filename) && answers.valueToEdit === "audio";
          return condition;
        },
        validate: function (response) {
          ...
          if (media_files.indexOf(response) >= 0 || response === "") {
            ...
            // TODO: replace "blank" with "" in then()
            return true;
          } else {
      ...
      // edit description?
      {
        ...
        when: function (answers) {
          if (data["description"] && answers.valueToEdit === "description") {
            console.log(
              "You've already entered a description: " +
                '"' +
                data["description"] +
                '"'
            );
      ...
      // description creator
      {
        ...
        when: function (answers) {
          return (
            data["description"] === "" && answers.valueToEdit === "description"
          );
        },
      },
      // genre
